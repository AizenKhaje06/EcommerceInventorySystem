  ...
  return (
    <div className="max-w-[1400px] mx-auto py-5 space-y-6">
      ...
      <Card className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-0 shadow-lg overflow-hidden">
        <div className="bg-slate-100 dark:bg-slate-900 px-6 py-5 border-b border-slate-200 dark:border-slate-700">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-xs ml-3 text-slate-500 dark:text-slate-400">
