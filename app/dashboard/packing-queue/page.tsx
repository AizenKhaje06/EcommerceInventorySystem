...
export default function PackingQueuePage() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-3 sm:px-4 lg:px-6 py-5 space-y-6">
      {/* Header with Title and Date Filter - Mobile Responsive */}
      <div className="flex flex-col gap-3 mb-4 sm:mb-6">
        <div>
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold gradient-text leading-tight">Packing Queue Overview</h2>
                      ...
                      <td className="py-1.5 px-4">
                        <div className="flex items-center justify-center gap-4">
                          ...
                          {!order.is_cancelled && (
                            <>
                              {order.confirmation_status === 'Unconfirmed' ? (
                                (userRole === 'admin' || userRole === 'logistics' || userRole === 'logistics-admin') && (
                                  <button
