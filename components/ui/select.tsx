...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn('text-slate-500 dark:text-slate-400 px-3 py-2 text-xs font-semibold uppercase tracking-wider', className)}
      {...props}
    />
  )
}
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-slate-100 dark:focus:bg-slate-800 focus:text-slate-900 dark:focus:text-white [&_svg:not([class*='text-'])]:text-slate-500 dark:[&_svg:not([class*='text-'])]:text-slate-400 relative flex w-full cursor-pointer items-center gap-3 rounded-[5px] py-3 pr-10 pl-3 text-sm outline-hidden select-none transition-colors min-h-[44px] data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className,
      )}
      {...props}
    >
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn('bg-slate-200 dark:bg-slate-700 pointer-events-none -mx-1 my-2 h-px', className)}
      {...props}
    />
  )
}
